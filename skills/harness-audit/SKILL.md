---
name: harness-audit
description: 检查当前项目的 harness 健康状态，读取质量记分卡、索引、安装验证和 workflow 信号，输出结构化审计结果；当用户说“harness audit”“健康检查”“检查 harness 状态”时使用。
---
...
3. 优先运行当前可用验证入口，例如安装冒烟或项目自身 smoke checks
