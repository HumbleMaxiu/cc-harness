...
- **Docs-first 操作面** — 文档不是附属说明，而是 harness 的主操作面：scaffold、workflow、feedback、quality gate、memory 都应能回写或消费 docs。
- **先 foundation，再 tooling** — 先补齐文档中心化的基础收口能力，再接入 UI 还原、e2e 生成、测试工具等更强的工具型能力。
